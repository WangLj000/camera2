...
public class ButtonManager implements SettingsManager.OnSettingChangedListener {
    ...
    public void hideModeOptions(int optionId) {
        View parent = null;
        if (optionId == R.id.mode_options_exposure_of_screen) {
        ...
        else if (optionId == R.id.mode_options_saturation)
            ...
            else if (optionId == R.id.mode_options_contrast)
            ...
            else if (optionId == R.id.mode_options_sharpness)
            ...
            else if (optionId == R.id.mode_options_brightness)
            ...
            else if (optionId == R.id.mode_options_hue)
